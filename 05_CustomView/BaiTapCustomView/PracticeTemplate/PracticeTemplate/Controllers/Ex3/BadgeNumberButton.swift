...
class BadgeNumberButton: UIButton {
    enum position {
        case topLeft
        case topRight
        case topCenter
        ...
        func addNumberBadgePosition(inRect bounds: CGRect) -> CGPoint {
            switch self {
            case .topLeft:
    ...
    var numberBagdePosition: position = .topLeft {
        didSet {
            numberBadgeLabel.center = numberBagdePosition.addNumberBadgePosition(inRect: bounds)
        }
    }
    ...
    override init(frame: CGRect) {
        ...
        numberBadgeLabel.center = numberBagdePosition.addNumberBadgePosition(inRect: frame)
        numberBadgeLabel.text = text
