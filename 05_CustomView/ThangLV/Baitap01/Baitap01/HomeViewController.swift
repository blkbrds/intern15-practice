...
class HomeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        scrollView.contentSize = CGSize(width: self.view.frame.size.width, height: 1400)
        setUpUI()
    }
    ...
    func setUpUI() {
        for _ in 0...9 {
            for _ in 0...2 {
                let avatarView = Bundle.main.loadNibNamed("MyAvatar", owner: self, options: nil)?[0] as! MyAvatar
...
//                avatarViews[index].delegate = self
