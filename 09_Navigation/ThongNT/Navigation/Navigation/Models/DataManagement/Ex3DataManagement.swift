...
final class Ex3DataManagement {

    static let share = Ex3DataManagement()
    private init() { }

    let filePath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true)[0].appending("/Avatars.plist")
    let nameFile = "Avatars"
    ...
    func saveDataToDocument(data: [AvatarData], currentName: String, newName: String) {
