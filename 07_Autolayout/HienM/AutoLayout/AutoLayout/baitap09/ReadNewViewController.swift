...
final class ReadNewViewController: UIViewController {

	@IBOutlet weak private var backImageButton: UIButton!
	@IBOutlet weak private var nextImageButton: UIButton!
	...
	@IBAction private func nextImageButton(_ sender: Any) {
		if x < 4 {
			x += 1
		} else { x += 0 }
	...
	@IBAction private func backImageButton(_ sender: Any) {
		if x > 0 {
			x -= 1
		} else { x -= 0 }
