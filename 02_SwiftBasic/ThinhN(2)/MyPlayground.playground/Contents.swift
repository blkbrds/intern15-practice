...
func lopHoc(lopHoc: [[String: Any]]) {
    ...
    for i in lopHoc {
        if let tenLop = i["tenLop"] as? String {
            tenLop1.append(tenLop)
        }
    }
    for i in lopHoc {
...
lietKeLapLai(mang: [2, 2, 1, 3, 3, 3, 4, 3, 4, 5, 5, 1, 1])
//Bai 50
...
demSoDuong(soNhap: [[-3.2, 3.3, 4.4, -95, 7, 8, -3], [-6.1, -5.3, -4, -3, -2], [2, 5]])
