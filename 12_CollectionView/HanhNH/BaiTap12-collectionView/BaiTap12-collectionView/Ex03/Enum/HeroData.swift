...
enum Team: Int {
    ...
    var members: [MemBer] {
        ...
        case .gokuultrainstinct:
            return [MemBer(name: "goku blue", avatar: #imageLiteral(resourceName: "goku6")), MemBer(name: "goku saiyan blue", avatar: #imageLiteral(resourceName: "gokubnvc3")), MemBer(name: "goku super blue", avatar: #imageLiteral(resourceName: "goku2")), MemBer(name: "goku super saiyan blue", avatar: #imageLiteral(resourceName: "gokubnvc6")), MemBer(name: "goku super saiyan blue", avatar: #imageLiteral(resourceName: "goku2")), MemBer(name: "goku super saiyan blue", avatar: #imageLiteral(resourceName: "gokubnvc3")), MemBer(name: "goku super saiyan blue", avatar: #imageLiteral(resourceName: "gokubnvc5"))]
        }
    }
