...
class SliderView: UIView {
    ...
    func setUpThumbnailView() {
        whiteSliderView = UIView(frame: CGRect(x: 0, y: 0, width: 20, height: 500))
        ...
        blueSliderView = UIView(frame: CGRect(x: 0, y: 250, width: 20, height: 250))
        if let blueSliderView = blueSliderView {
            blueSliderView.backgroundColor = .systemBlue
            self.addSubview(blueSliderView)
        }
        thumbnailView = UIView(frame: CGRect(x: -10, y: 230, width: 40, height: 40))
