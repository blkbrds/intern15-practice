...
class Ex03ViewController: UIViewController {
    ...
    let userName: String = "hanh.nguyen3"
    let passwork: String = "123123"
    enum Error : String{
           case khongNhapChu = "Không nhập cm gì"
           case nhapSai = "Nhập sai cmnr"
           case thieu = "Thiếu cmnr"
       }
    ...
    //            informLabel.text = "Chúc mừng bạn đăng nhập thành công"
    //        } else {
    //            informLabel.text = "Nhập sai username hoặc password"
    //        }
           switch (userNameText.text, passworkText.text) {
           case ("", ""):
               labelView.text = Error.khongNhapChu.rawValue
           case (userName,passwork):
               labelView.text = "Nhập đúng cmnr"
           case ("",""):
