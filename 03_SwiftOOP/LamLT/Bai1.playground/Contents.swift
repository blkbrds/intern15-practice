...
class Fraction {
    ...
    func minimalistFraction(a1: Int, b1: Int) -> String {
    ...
    func congPhanSo(f: Fraction) -> String {
    ...
    func truPhanSo(f: Fraction) -> String {
        let ts: Int = numerator * f.denominator - f.numerator * denominator
        let ms: Int = denominator * f.denominator
        let result = minimalistFraction(a1: ts, b1: ms)
        return result
    ...
    func nhanPhanSo(f: Fraction) -> String {
    ...
    func chiaPhanSo(f: Fraction) -> String {
