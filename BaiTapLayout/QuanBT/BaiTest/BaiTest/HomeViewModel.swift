...
final class HomeViewModel {
    ...
    func getData() {
        ...
        let data2 = DataTest(name: "Nguyễn Văn B", tieusu: "Tiểu sử là Tiểu sử là Tiểu sử là Tiểu sử là Tiểu sử là Tiểu sử là Tiểu sử là Tiểu sử là Tiểu sử là Tiểu sử là Tiểu sử là Tiểu sử là  Tiểu sử là Tiểu sử là Tiểu sử là Tiểu sử là Tiểu sử là Tiểu sử là Tiểu sử là Tiểu sử là Tiểu sử là", diachi: "Hải Châu, Đà Nẵng", gioitinh: "Nam", ngay: "09-09-2009", image: "img-avatar")
